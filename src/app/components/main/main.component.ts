...
export class MainComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.deconvertedMessage = this.appService.deconvertMessage(
      this.convertedMessage.replaceAll(' ', '')
    );
  }
  ...
  getConvertedMessageLength() {
   return this.convertedMessage.replaceAll(' ', '').length;
  }
}
